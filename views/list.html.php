...
<div class="max-w-5xl mx-auto px-3">
        <div class="text-center mb-8">
            <a class="bg-gray-900 px-4 py-2 text-white inline-block rounded hover:bg-gray-700 duration-200" href="/creat">
                Créer un livre
            </a>
        </div>

        <div class="mb-6 text-center text-2xl">
            Vous avez cherché "toto". Nous avons 2 résultats.
        </div>
            ...
            <div class="w-1/2 lg:w-1/4 mb-6">
                <div class="shadow-lg rounded-lg h-full mx-3">
                    <div class="flex flex-col justify-between h-full">
                        <a href="/book/1">
                            <img class="rounded-t-lg" src= "<?= $book['image']; ?> " alt="Quae dolor itaque toto reiciendis ad quae.">
                            <div class="p-4">
                                <h2 class="text-center"> <?= $book['title'];?> </h2>
                                <div class="flex justify-around items-center">
                                    <p class="text-lg font-bold"> <?= $book['price']; ?>€</p>
                                    <p class="text-xs font-bold">-19%<span class="line-through"><?= $book['discount']; ?></span></p>
                                </div>
                                <p class="text-xs text-center text-gray-400">
                                    Par <strong> <?= $book['author']; ?> </strong> <?= $book['published_at'] ?>
                                </p>
                                <p class="text-xs text-center text-gray-400">
